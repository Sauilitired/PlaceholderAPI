...
public final class ExpansionManager {
    ...
    public boolean registerExpansion(PlaceholderExpansion expansion) {
        ...
        if (expansion instanceof VersionSpecific) {
            ...
            if (!nms.isCompatibleWith(PlaceholderAPIPlugin.getServerVersion())) {
                plugin.getLogger().info(
                    "Your server version is not compatible with expansion: " + expansion
                        .getIdentifier() + " version: " + expansion.getVersion());
                return false;
            }
        }
        ...
        if (plugin.getExpansionCloud() != null) {
            CloudExpansion ce =
                plugin.getExpansionCloud().getCloudExpansion(expansion.getIdentifier());
            if (ce != null) {
    ...
    public PlaceholderExpansion registerExpansion(String fileName) {
        List<Class<?>> subs =
            FileUtil.getClasses("expansions", fileName, PlaceholderExpansion.class);
