...
@SuppressWarnings({"unused", "WeakerAccess"}) public class PlaceholderAPI {
    ...
    public static Set<PlaceholderExpansion> getExpansions() {
        Set<PlaceholderExpansion> set =
            getPlaceholders().values().stream().filter(PlaceholderExpansion.class::isInstance)
    ...
    public static String setPlaceholders(OfflinePlayer player, String text,
        ...
        while (m.find()) {
            ...
            if (hooks.containsKey(identifier)) {
                ...
                if (value != null) {
                    text =
                        text.replaceAll(Pattern.quote(m.group()), Matcher.quoteReplacement(value));
                }
            }
        }
        return color(text);
     ...
     */
    public static List<String> setRelationalPlaceholders(Player one, Player two,
        List<String> text) {
        if (text == null) {
            return null;
        }
    ...
    @Deprecated public static Set<String> getRegisteredPlaceholderPlugins() {
        return getRegisteredIdentifiers();
    }

    @Deprecated public static Set<String> getExternalPlaceholderPlugins() {
        return null;
    }
    ...
    @Deprecated public static boolean unregisterPlaceholderHook(Plugin plugin) {
